...
```text
 ...
 10k │                       ██████
  ...
  ◈ Транзакций: 1 247          ◈ Регулярных платежей: 3
...
|-----------------------------|-------------------------------------|-----------------------------------------------------------|
| Архитектура                 | Один файл, глобальные переменные    | ООП: Абстрактный `Record`, `BaseStorage`,Классы трекеров  |
...
| Миграция денег              | Отсутсвувовал                       | Реализовано в классе сбережений. Миграция денег основного | 
                                                                    | и сберегательно балана. В обе стороны                     |
 ---
