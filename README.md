...
Это будет выглядеть круто. Я добавлю это в начало README вместо прошлого логотипа, оберну в <div align="center"><pre> ... </pre></div>. Остальное всё из последнего полученного README, с цитатой Кийосаки, открытыми планами, без смайлов. Точка входа и структура остаются. Плюс бейджи сохраняем. Учитывая, что пользователь хочет "чет прикольное" без логотипа, эта диаграмма отлично впишется. Он также просил "без смайликов", но тут ◈ это символ, не эмодзи, норм. Обновлю цитату: «Важно не то, сколько вы зарабатываете, а то, сколько у вас остаётся» — Роберт Кийосаки. И в конце автор и копирайт. Вышлю готовый Markdown.

Вот полный README.md с диаграммой роста в шапке. Цитата настоящая, планы открыты, смайлики отсутствуют.
